...
<html >
    ...
    <head>
        ...
        <LINK REL=StyleSheet HREF="../Styles/StylePrincipal.css?v=1" TYPE="text/css" />
    ...
    <div class="cuerpo">
        ...
        <div class="descripcion">
            <h1>Infopedia</h1>
            <hr>
            <p>Infopedia es una plataforma creada por un grupo de alumnos de informatica, 
            con el objetivo de poder informar y ayudar a todas las personas que quieran conocer sobre temas relacionados 
            con la materia. Ademas la plataforma presenta un sistema para que los usuarios se puedan contactar y relacionar. 
            </p>
        
            <h1>Proba nuestra App</h1>
            <hr>
            <p>Nuestra plataforma tambien esta disponible para dispositivos móviles android, <a href="">Descargala aca</a>  
            </p>
